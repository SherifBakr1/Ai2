...
MAX_EPISODE = 1500   # DURING THE DEVELOPMENT/IMPLEMENTATION PLEASE FEEL FREE TO CHANGE THIS VALUE
...
def Qlearn():
    ...
    while episode < (MAX_EPISODE):
        ...
        while not rospy.is_shutdown():
            ...
            next_state = get_state_initial(front, right)
            print("THE very next state is", next_state)
