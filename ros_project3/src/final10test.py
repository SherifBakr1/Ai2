...
def laserscan_callback(msg):
    ...
    range_right = min(msg.ranges[250:270])  # right FOV (between 300 to 345 degrees)
    if range_right == 0:
        range_right == 1.0
...
# LOST_DISTANCE_THRESHOLD =0.7    
    ...
    if (range_right <0.10):
        right ="vclose"  
    elif ( 0.20<range_right< 0.30):
        right= "close"
    elif (0.30 <range_right < 0.35):
        right = "normal0"
    elif (0.35 <range_right < 0.45):
        right = "normal1"
    elif (0.45 < range_right ):
        right = "far"
